...
/**
 * Subcommand to list the filenames of the currently created architecture
 * decision records
 * 
 * @author adoble
 *
...
@Command(name = "list", description = "Lists the filenames of the currently created architecture decision records.")
